...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (karsilastirBtn) {
        karsilastirBtn.addEventListener("click", async () => {
            ...
            sonucDiv.innerHTML = `<div class="loading"><div class="spinner"></div><p>⏳ Karşılaştırma yapılıyor...</p></div>`;
            try {
    ...
    if (ajanBtn) {
        ajanBtn.addEventListener("click", async () => {
            ...
            sonucDiv.innerHTML = `<div class="loading"><div class="spinner"></div><p>⏳ Akıllı ajan çalışıyor...</p></div>`;
            try {
