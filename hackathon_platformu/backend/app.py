...
def toplu_analiz():
    ...
    for grup in gruplar:
        ...
        time.sleep(0.5)  # rate limiting (mock)
...
def ajan():
    ...
    adim1 = ajan_adim1_veri_hazirla(urun_adi, yorumlar)
    adim2a = ajan_adim2a_duygu(urun_adi, yorumlar)
    adim2b = ajan_adim2b_kategoriler(urun_adi, yorumlar)
    iyilestirmeler = ajan_adim2c_iyilestirmeler(urun_adi, adim2b)
    rapor = ajan_adim3_rapor(urun_adi, adim2a, adim2b, iyilestirmeler)
    aksiyonlar = ajan_adim4_aksiyonlar(urun_adi, adim2b, iyilestirmeler)
